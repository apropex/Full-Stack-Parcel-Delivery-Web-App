...
import { useCancelParcelMutation } from "@/redux/features/parcel.api";
...
export function CancelParcel({ children, id }: iProps) {
  ...
  const onSubmit = async (data: StatusFormValues) => {
    ...
    try {
      ...
      console.log(error);
      toast.error("Failed to cancel parcel", { id: loaderId });
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Your are going to cancel the parcel.</DialogDescription>
        </DialogHeader>
