...
const registerSchema = z
  .object({
    ...
    role: z.enum([ROLES.SENDER, ROLES.RECEIVER], { error: "Role is required" }),
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value={ROLES.SENDER}>Sender</SelectItem>
                      <SelectItem value={ROLES.RECEIVER}>Receiver</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
