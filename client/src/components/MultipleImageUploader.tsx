...
export interface iMultipleImageUploaderRef {
  clearAll: () => void;
}

const MultipleImageUploader = forwardRef<iMultipleImageUploaderRef, iProps>(
  ({ onChange, defaultFiles }, ref) => {
    const maxSizeMB = 5;
    const maxSize = maxSizeMB * 1024 * 1024; // 5MB default
    const maxFiles = 3 - (defaultFiles || 0);
    ...
    function clearFiles() {
      files.forEach(({ id }) => removeFile(id));
    }
