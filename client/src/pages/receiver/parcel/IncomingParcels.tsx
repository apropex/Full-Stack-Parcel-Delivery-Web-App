...
import { useIncomingParcelsQuery } from "@/redux/features/parcel.api";
...
export default function IncomingParcels() {
  const { data, isLoading, isError } = useIncomingParcelsQuery(AllSearchParams(), {
  ...
  return (
    <section>
      <div className="text-center">
        <h2 className=" text-3xl font-semibold">Incoming Parcels</h2>
